...
def preprocessing(cor_data,sample_vector):
    ...
    sample_vector = sample_vector.round(3)
...
def main():
    ...
    all_corpus, train_data = preprocessing(cor_data,sample_vector)
    ...
    while(1):
        print('예측할 vector를 입력하세요')
        predict_vector = input()

        if predict_vector =='q':
            break

        predict(predict_vector)
